...
public class MostrarMateryRecim  extends RecyclerView.Adapter<MostrarMateryRecim.ViewHolder> implements View.OnClickListener{
    ...
    public List<mensajes> promedioLista;
    ...
    public  MostrarMateryRecim(List<mensajes> promedioLista){
