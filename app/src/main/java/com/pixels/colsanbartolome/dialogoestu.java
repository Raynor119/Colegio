...
public class dialogoestu extends AppCompatActivity {
    public List<profes> usurr=new ArrayList<>();
    public List<estudit> promedioLista =new ArrayList<>();
    String user,cont;
    int p;
    String dat="0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dialogoestu);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        promedioLista.add(new estudit(jo.getString("usuario"), jo.getString("contrasena"), jo.getString("nombre"), jo.getString("materias"), jo.getString("cursos"), jo.getString("tipo")));
                ...
                if(confu==1){
                    ...
                    if(conr.equals(cont)){
                        ...
                        Intent intent =new Intent(dialogoestu.this,menuestudiantes.class);
                        ...
                        Intent intent=new Intent(dialogoestu.this,estudianteinicio.class);
                        startActivity(intent);
                        finish();
