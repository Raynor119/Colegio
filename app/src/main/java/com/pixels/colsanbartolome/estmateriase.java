...
public class estmateriase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estmateriase);
        ...
        adaptadormateria.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                for(int i=0;i<curs1.length();i++){
                    ...
                    String ll=""+l;
                    if(ll.equals(" ")||ll.equals(",")||ll.equals(".")|| ll.equals("-")){
                    }else{
                        mat=mat+ll;
                    }
                }

                Intent intent=new Intent(estmateriase.this,mensajeses.class);
